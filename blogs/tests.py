...
class UserTest(TestCase):
    ...
    def test_unique_login(self) -> None:
...
class BlogTest(TestCase):
    ...
    def test_blog_creation(self) -> None:
    ...
    def test_blog_belongs_to_author(self) -> None:
...
class PostTest(TestCase):
    ...
    def test_post_belongs_to_blog(self) -> None:
    ...
    def test_post_belongs_to_author(self) -> None:
